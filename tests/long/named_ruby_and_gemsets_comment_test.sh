...
rvm remove  2.7.5-ntest --gems

## without gemsets

rvm install 2.7.5-ntest --skip-gemsets --disable-binary
# status=0
...
rvm install 2.7.5-ntest
# status=0; match=/Already installed/

rvm 2.7.5-ntest do which gem
# match=/2.7.5-ntest/

rvm 2.7.5-ntest do gem env

rvm 2.7.5-ntest do gem list
# match[stderr]=/\A\Z/
# match[stdout]!=/rubygems-bundler/

rvm 2.7.5-ntest do ruby -v
# match=/2.7.5/
...
rvm 2.7.5-ntest@global do gem list
# match[stderr]=/\A\Z/
# match[stdout]!=/haml/
# match[stdout]=/tf/
...
ls -1d $rvm_path/environments/*2.7.5-ntest*   # status!=0
ls -1d $rvm_path/wrappers/*2.7.5-ntest*       # status!=0
ls -1d $rvm_path/gems/*2.7.5-ntest*           # status!=0
ls -1d $rvm_path/bin/*2.7.5-ntest*            # status!=0

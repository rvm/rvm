...
rvm use 2.6.6      # status=0; match=/Using / ; env[GEM_HOME]=/2.6.6/
rvm current             # match=/2.6.6/
command rvm use 3.0.5   # status=0; match!=/Using /; env[GEM_HOME]!=/2.4.0/ ; match=/RVM is not a function/
rvm use 3.0.5           # status=0; match=/Using / ; env[GEM_HOME]=/2.4.0/
